...
---
发布丢失物品：用户发布寻物启事，表示自己丢了东西；发布捡到物品：用户发布招领信息，等待失主提交认领申请。
示例：
用户发布物品
    ↓
选择发布类型
...
认领流程：用户看到疑似自己的物品后，不能直接认领，而是提交包含证明信息的认领申请；系统保存申请记录，管理员根据用户描述与物品真实特征进行核对，审核通过后更新认领申请状态，并把物品状态改为已认领；审核驳回则保留物品为待认领状态，允许后续继续申请。
示例：
发布捡到物品
    ↓
填写公开信息：
